...
from ShapefileToNetwork.main.shortest_paths.BufferedGraph import *
from ShapefileToNetwork.main.convertor.MultiDiGraphConvertor import MultiDiToSimple
...
class ShortestPath:
    ...
    def assign_tuple(self, coord):
        ...
        print(geometry)
        pos = {k: v for k,v in enumerate(new_g.nodes())}
    ...
    def find_shortest_paths(self, start_tuple, end_tuple):
        geometry = Point(start_tuple[0], start_tuple[1])
